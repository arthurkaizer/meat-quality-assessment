...
class Files:
    @staticmethod
    def _get_image_at(path: str) -> ImageMat:
    ...
    @staticmethod
    def get_files_and_corresponding_classes() -> Tuple[List[ImageMat], List[ImageClasses]]:
        images: List[ImageMat] = []
